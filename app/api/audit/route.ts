...
export async function GET(request: Request) {
  ...
  const actionLabels: Record<string, string> = { create: "创建", update: "更新", grade: "评分", submit: "提交", generate: "生成", publish: "发布", reject: "拒绝", link: "关联", relate: "建立关系", join: "加入" };
  const objectLabels: Record<string, string> = { assignment: "作业", personalized_assignment: "个性化作业", ai_draft: "AI 草稿", knowledge_point: "知识点", class: "班级", learning_task: "学习任务", activity: "课堂活动" };
